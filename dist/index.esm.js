...
function initializeBoxLangSupport$1() {
	...
	monaco.languages.setLanguageConfiguration( "boxlang", boxlangLanguageConfig$1 );
	monaco.languages.setLanguageConfiguration( "boxlang-template", boxlangLanguageConfig$1 );

	// Set syntax highlighting
	monaco.languages.setMonarchTokensProvider( "boxlang", boxlangMonarchTokens$1.script );
	monaco.languages.setMonarchTokensProvider( "boxlang-template", boxlangMonarchTokens$1.template );

	// Define BoxLang theme
	monaco.editor.defineTheme( "boxlang-theme", boxlangTheme$1 );
